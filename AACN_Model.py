...
from AACN_Layer import AACN_Layer
...
class BasicBlock(nn.Module):
    ...
    def __init__(
        ...
        if not attention:
            ...
            self.conv2 = AACN_Layer(in_channels=width, out_channels=width, k=0.25, v=0.25, kernel_size=3, num_heads=8, image_size=image_size, inference=inference)
...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        if not attention:
            ...
            self.conv2 = AACN_Layer(in_channels=width, k=0.25, v=0.25, kernel_size=3, num_heads=8, image_size=image_size, inference=inference)
